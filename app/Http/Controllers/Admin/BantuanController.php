...
class BantuanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('apps.admin.klasifikasi_bantuan.index')->with('bantuan', $bantuan)
                                                ->with('q_nama', $q_nama)
                                                ->with('q_kk', $q_kk)
                                                ->with('q_nik', $q_nik);
    }
    ...
    public function create()
    {
        ...
        return view('apps.admin.klasifikasi_bantuan.create')->with('penduduk', $penduduk)->with('jenis_bantuan', $jenis_bantuan);
    }
    ...
    public function insert(Request $request)
    {
        ...
        return redirect()->route('admin.bantuan');
    }
    ...
    {   
        ...
        return view('apps.admin.klasifikasi_bantuan.edit')->with('bantuan', $bantuan)->with('jenis_bantuan', $jenis_bantuan)->with('penduduk', $penduduk);
    }
