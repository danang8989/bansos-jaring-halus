...
class DaftarPenyaluranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('apps.kepdes.daftar_penyaluran.index')->with('bantuan', $bantuan)
    ...
    {   
        ...
        return view('apps.kepdes.daftar_penyaluran.edit')->with('bantuan', $bantuan)->with('jenis_bantuan', $jenis_bantuan)->with('penduduk', $penduduk);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('kepdes.daftar_penyaluran');
    }
}
