          ...
          <div class="col-12 grid-margin stretch-card">
            <div class="card card-rounded">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin.bantuan.update') }}" method="POST">
                        @csrf @method('PUT')
                        ...
                        <div class="form-group form-group-sm">
                          ...
                          <select type="text" class="form-control form-control-sm" id="penduduk" name="jenis_bantuan_id" placeholder="Bahan Makanan">
                            <option value="">-Silahkan Pilih-</option>
