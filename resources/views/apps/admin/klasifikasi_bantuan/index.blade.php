            ...
            <div class="card card-rounded">
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-start">
                  ...
                  <form action="{{ route('admin.bantuan') }}" style="display: flex;" method="GET">
                        ...
                        @foreach ($bantuan as $item)
                            <tr>
                              ...
                              <td>{{ $item->jenisBantuan->nama }}</td>
                                <td width="30%">
                                    <a href="{{ route('admin.bantuan.edit', $item->id) }}" style="text-decoration: none"> 
                                        <button class="btn btn-warning btn-sm text-white mb-0 me-0" type="button"><i class="mdi mdi-pencil"></i>Edit</button>
                                    </a>
                                    <form action="{{ route('admin.bantuan.delete') }}" style="display: inline-block" method="POST">
                                        @csrf @method('DELETE')
