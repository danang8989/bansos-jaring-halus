            ...
            <div class="card card-rounded">
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-start">
                  ...
                  <form action="{{ route('admin.penduduk') }}" style="display: flex;" method="GET">
                    ...
                    <tbody>
                        ...
                        @foreach ($penduduk as $item)
                            <tr>
                                ...
                                <td>{{ $item->umur }}</td>
                                <td width="30%">
                                    <a href="{{ route('admin.penduduk.edit', $item->id) }}" style="text-decoration: none"> 
                                        <button class="btn btn-warning btn-sm text-white mb-0 me-0" type="button"><i class="mdi mdi-pencil"></i>Edit</button>
                                    </a>
                                    <form action="{{ route('admin.penduduk.delete') }}" style="display: inline-block" method="POST">
                                        @csrf @method('DELETE')
